(function (global, factory) {
	...
	***************************************************************************** */
	...
	function createComponent(parent, element) {
	  ...
	  var zIndex = props.zIndex; // 每个组件都新建一个独立容器
	...
	***************************************************************************** */
	...
	var ImageGuideView = (function (props, context) {
	  ...
	  var offsetXNum = context.px2hd(offsetX);
	  var offsetYNum = context.px2hd(offsetY);
	  var posX = x + (offsetXNum || 0) - heightNum / 2;
	  var posY = y + (offsetYNum || 0) - widthNum / 2;
	  return jsx("group", {
	    style: style
	  }, jsx("image", {
	...
	var Zoom = /*#__PURE__*/function (_Component) {
	  ...
	  function Zoom(props) {
	    ...
	    _this.scale = {};
	    _this.originScale = {}; //swipe end x y
	  ...
	  _createClass(Zoom, [{
	    ...
	    value: function willMount() {
	      ...
	      var minCount = props.minCount,
	          range = props.range; // const { range } = state;
	    ...
	    value: function _doYPinch(ev) {
	      ...
	      var bottomLen = Math.abs(bottom - center.y); // 计算左右缩放的比例
	    ...
	    value: function updateRange$1(originalRange, dim) {
	      ...
	      var range = state.range;
	      if (range && isEqual$1(newRange, range[dim])) return newRange; // 更新主 scale
	    ...
	    value: function _bindEvents() {
	      ...
	      var onPinchStart = props.onPinchStart,
	          ...
	          onPinchEnd = props.onPinchEnd; // 统一绑定事件
